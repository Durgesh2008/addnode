...
const PhoneLogin = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center md:w-[1040px] md:h-[592px]">
    ...
    <div className="lg:w-2/6  bg-[#E4F7F9]  rounded-[5px] -lg p-8 flex flex-col md:px-10 py-[130px] w-full mt-1 md:mt-0 md:w-[520px] md:h-[592px]  md:flex-1">
      <h2 className="text-lg font-semibold title-font  text-[#000] md:text-[32px] text-center mb-8">Enter Phone Number</h2>
      
      <div className="relative mb-4 flex gap-1 justify-center">
      <input type="button" id="full-name" name="full-name" className=" w-[20%] font-s2 bg-white rounded-[5px]  border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200  outline-none py-1 px-3 leading-8 font-medium transition-colors duration-200 ease-in-out text-[#000] text-2xl " value={'+91'}/>
      <input type="tel" id="full-name" name="Tele" className="w-[70%] font-s2  bg-white rounded-[5px]  border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-2xl outline-none py-1 px-3 leading-8 font-medium transition-colors duration-200 ease-in-out text-[#000] " />
