...
const Login = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center md:w-[1040px] md:h-[592px]">
    ...
    <div className="lg:w-2/6  bg-[#E4F7F9]  rounded-[5px] -lg flex flex-col md:px-10 py-10 md:py-0 w-full mt-1 md:mt-0 md:w-[520px] md:h-[592px]  md:flex-1">
      ...
      <div className="relative mb-4">
        <input type="password" id="full-name" name="full-name" className="w-full font-s2 bg-white rounded-[5px]  border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none py-1 px-3 leading-8 font-medium transition-colors duration-200 ease-in-out text-[#0A5E6659] " placeholder='Password'/>
      </div>
      ...
      <p className="text-xs font-medium text-[#535353] font-s2 text-center mt-1">Already a member? <Link to={'/'} className='font-semibold text-[#F07319]'>Sign In</Link></p>
